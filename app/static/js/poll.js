    ...
    render: function(){
      ...
      <div>
        <form id="poll_form" className="form-signin" onSubmit={this.handleSubmit}>
          <h2 className="form-signin-heading" style={Align}>Create Election</h2>
  
          <div className="form-group has-success">
            <label htmlFor="title" className="sr-only">Name of the Election</label>
          ...
          <div className="form-group has-success">
            <label htmlFor="option" className="sr-only">Candidate</label>
          ...
          <div className="row form-group">
            <button className="btn btn-lg btn-success btn-block" type="button" onClick={this.handleOptionAdd}>Add Candidate</button>
            <button className="btn btn-lg btn-success btn-block" type="submit" onClick={this.handleSubmit}>Help Election</button>
          </div>
          <br />
        </form>
